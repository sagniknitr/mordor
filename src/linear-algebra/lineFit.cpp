...
static inline sum_of_squares(const float32_t pf32_input[], uint32_t u32_vector_size)
{
    return dot_product_f32(pf32_input, u32_vector_size);
}


static inline mean_f32(float32_t pf32_input[], uint32_t u32_vector_size)
{
...
static inline de_mean_f32( const float32_t pf32_input[], uint32_t u32_vector_size, float32_t pf32_output[])
{
